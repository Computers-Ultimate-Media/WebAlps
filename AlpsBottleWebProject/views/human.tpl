...
<p>An abbreviation of the word attribute is <abbr title="attribute">attr</abbr>.</p>-->
        ...
        <br/>
        <div class="text-center">
            <iframe class="size-bio" marginheight="20" src="{{vid1}}" title="YouTube video player" frameborder="0"
                    allow="autoplay; clipboard-write; encrypted-media; picture-in-picture" allowfullscreen></iframe>
        </div>
        <br/>
        <div class="text-center">
            <iframe class="size-bio" width="1640" height="723" src="{{vid2}}" title="YouTube video player"
                    frameborder="0"
